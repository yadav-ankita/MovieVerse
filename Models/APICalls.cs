...
namespace MovieVerse.Models
{
    ...
    {
        string API_KEY = Environment.GetEnvironmentVariable("TMDB_API_KEY");
        string BASE_URL = "https://api.themoviedb.org/3";
        private readonly IHttpClientFactory _httpClientFactory;
        public APICalls(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<MovieRoot> GetMovie()
        {
            try
            {
                ...
                MovieRoot obj = JsonConvert.DeserializeObject<MovieRoot>(responseBody) ?? throw new Exception("Deserialization failed");
